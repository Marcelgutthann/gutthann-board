...
const AL={ingest:'Schnell-Sync',scan:'Voll-Scan','auto-sync':'Auto-Sync',nachhaken:'Nachhaken',ping:'KI-Test','email-draft':'Outlook-Entwurf','dashboard-analyse':'Dashboard-Analyse','lph-katalog':'LPH-Katalog',projektbericht:'Projektbericht','termin-check':'Termin-Abgleich','termin-karten':'Termin-Karten','angebote-check':'Angebots-Check',lph2:'LPH 2',lph3:'LPH 3',lph4:'LPH 4',lph5:'LPH 5',lph6:'LPH 6',lph7:'LPH 7',lph8:'LPH 8'};
...
function renderAgentPanel(viewId,D,ex){
  ...
  const side=(viewId==='angebote'?'<button class="av-run" data-agent="angebote-check">▶ Angebote prüfen</button> ':'')+(viewId==='termine'?'<button class="av-run" data-agent="termin-check">▶ Zeitpläne abgleichen</button> ':'')+(viewId==='termine'?'<button class="av-run" data-agent="termin-karten">▶ Termine ins Board</button> ':'')+'<button class="av-run" data-agent="dashboard-analyse">▶ Aktualisieren</button><div class="av-lastrun">'+(hasD?'Stand <strong>'+fmtD(lastStand||today())+'</strong>':'noch nicht analysiert')+'</div>';
